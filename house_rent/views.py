...
def home(request):
    ...
    return render(request, 'house_rent/home.html', {'houses': houses})
...
def dashboard(request):
    ...
    return render(request, 'house_rent/dashboard.html', {
        'houses': houses,
...
def parcel_list(request):
    ...
    return render(request, 'house_rent/parcel_list.html', {
        'parcels': parcels,
...
def house_detail(request, pk):
    ...
    return render(request, 'house_rent/house_detail.html', {
        'house': house,
        'images': images,
        'form': form
    })
...
def contact(request):
    return render(request, 'house_rent/contact.html')

def parcel_list(request):
    parcels = Parcel.objects.all()
    return render(request, 'house_rent/parcel_list.html', {'parcels': parcels})
...
def parcel_detail(request, pk):
    ...
    return render(request, 'house_rent/parcel_detail.html', {
        'parcel': parcel,
        'images': images,
        'form': form
    })
